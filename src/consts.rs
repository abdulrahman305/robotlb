...
pub const LB_CHECK_INTERVAL_LABEL_NAME: &str = "lb-tracker/lb-check-interval";
pub const LB_TIMEOUT_LABEL_NAME: &str = "lb-tracker/lb-timeout";
pub const LB_RETRIES_LABEL_NAME: &str = "lb-tracker/lb-retries";
pub const LB_PROXY_MODE_LABEL_NAME: &str = "lb-tracker/proxy-mode";
